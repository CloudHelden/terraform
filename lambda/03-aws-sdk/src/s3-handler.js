export const handler = async (event) => {
    ...
    console.log('Hello World from S3 Lambda!');
    ...
    // TODO: Hier AWS SDK Code für S3 hinzufügen
    // Beispiel: import { S3Client, PutObjectCommand } from "@aws-sdk/client-s3";

    return {
        statusCode: 200,
        body: JSON.stringify({
            message: 'Hello World from S3 Lambda!'
        })
    };
};
